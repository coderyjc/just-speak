...
应用启动后会常驻 Windows 通知区域。关闭主界面会将其隐藏到托盘；左键单击托盘图标可重新打开主界面。右键菜单提供“打开主界面”“显示/关闭悬浮窗”和“关闭”，选择“关闭”会结束应用及正在运行的任务。
...
Mini 用“读取屏幕、正在录音、文本清洗、定向修复、完成”五个单行状态同步显示同一条实时流程。右侧主页按钮可退出 Mini 并直接返回主界面主页；悬浮胶囊可拖动，并保持在其他窗口上方。
