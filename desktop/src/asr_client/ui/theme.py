...
QPushButton#heatmapRangeButton {
    color: #8a918f;
    background: transparent;
    border: 0;
    border-radius: 5px;
...
QPushButton#heatmapRangeButton:hover { color: #30383e; background: #f1eee7; }
QPushButton#heatmapRangeButton:checked { color: #c9472c; background: #ffe3d9; }
QPushButton#heatmapRangeButton:pressed { padding-top: 2px; padding-bottom: 0; }
QLabel#heatmapRangeDivider { color: #c9c5bc; padding: 0 1px; font-size: 9px; }
...
QWidget#recordingDot { background: transparent; }
...
QPlainTextEdit#readonlyTranscript {
    background: #faf9f5;
    border: 1px solid #ebe7de;
}
QPlainTextEdit#readonlyTranscript:focus {
    background: #fffefb;
    border-color: #d9d4ca;
}
